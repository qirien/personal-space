...
# Default Event
label creative_def:
    call play_scene_music from _call_play_scene_music_131
...
# Intro Event
label creative_0:
    call play_scene_music from _call_play_scene_music_132
    scene bg farm_interior with fade
...
# Scarecrow
label creative_1:
    call play_scene_music from _call_play_scene_music_133
    scene bg farm_interior with fade
...
label creative_2:
    call play_scene_music from _call_play_scene_music_134
    scene bg farm_interior with fade
...
label creative_3:
    call play_scene_music from _call_play_scene_music_135
    scene bg farm_interior with fade
...
# Make rope
label creative_4:
    call play_scene_music from _call_play_scene_music_136
    scene bg farm_interior with fade
...
label creative_5:
    call play_scene_music from _call_play_scene_music_137
...
# Photography
label creative_6:
    call play_scene_music from _call_play_scene_music_138
...
label creative_7:
    call play_scene_music from _call_play_scene_music_139
...
label creative_8:
    call play_scene_music from _call_play_scene_music_140
    scene bg pond with fade
...
label creative_master:
    call play_scene_music from _call_play_scene_music_141
    scene bg sunset with fade
